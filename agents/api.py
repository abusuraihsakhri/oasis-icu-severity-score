"""
FastAPI REST API Server for Oasis Icu Severity Score.
"""
...
app = FastAPI(
    title="Oasis Icu Severity Score API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "oasis-icu-severity-score", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
